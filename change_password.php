...
<!-- 
            ...
            <div class="row col col-md-12 m-auto" id="change">
              ...
              <div id="change_button" class="col col-md-5 form-group float-right">
                <button class="btn btn-success form-control font-weight-bold" onclick="changePassword();">Reset Password</button>
              </div>
              <div id="password_button" class="col col-md-5 form-group float-right">
                <a href="my_profile.php" class="btn btn-primary form-control font-weight-bold">Pharmacy Profile</a>
              </div>
            </div>

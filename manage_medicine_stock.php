        ...
        <div class="row">
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
                ...
                <?php
require 'php/manage_medicine_stock.php';  // Assuming this file contains the required functions.

if(isset($_GET['out_of_stock'])) {
    searchMedicineStock('0', 'QUANTITY');
} else if(isset($_GET['expired'])) {
    // Ensure this calls the function with correct parameters for expired stock
    $currentDate = date('m/y');  // Current date in mm/yy format
    searchMedicineStock($currentDate, 'EXPIRY_DATE');
} else {
    // Default view showing all or a subset of medicines.
